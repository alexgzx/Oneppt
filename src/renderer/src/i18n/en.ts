...
export const en = {
  ...
  settings: {
    ...
    freeModelNoApiKey: 'Free Model',
    freeModelDescription: 'No API Key required. Ready to use.',
    testSuccess: 'Connected successfully in {latency}ms',
    testFailed: 'Connection failed: {message}',
    scanModels: 'Scan Models',
    scanning: 'Scanning...',
    scanSuccess: 'Scan successful, added {count} free models',
    scanFailed: 'Scan failed: {message}',
    scanAdded: 'Found {total} free models, added {added}',
    scanFoundNew: 'Found {count} new free models',
    scanNoNew: 'No new free models found',
